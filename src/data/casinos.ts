...
export const casinos: Casino[] = [
  ...
  },
  {
    ...
    bonusDescription: "30€ offert — Bonus 100% jusqu'à 1000€ + Free Spins sur Mental NoLimit (code MELCHIORFS)",
    affiliateUrl: "https://betify3.sh/fr?registration=1&token=eAnPr3nom-KJijNAFD4owWNd7ZgqdRLk",
    pros: ["Wager x35", "30€ offert", "Free Spins Mental NoLimit", "Sans VPN"],
  ...
  },
  {
    ...
    bonusTitle: "Bonus de Bienvenue",
    bonusAmount: "25€ Offerts*",
    bonusDescription: "25€ offert — 1350€ + 300 FS sur 3 dépôts (150% + 100% + 100%)",
    affiliateUrl: "https://partners.vibespartners.com/v2/text/3/4/f1941a42-cfd3-11f0-93c1-3e6b14ec5c14/1",
    pros: ["1350€ + 300 FS sur 3 dépôts", "Wager dégressif (x35/x30/x25)", "25€ gratuit via Discord", "Bonne variété de jeux"],
    cons: ["Max bet 5€"],
